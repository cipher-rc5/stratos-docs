      ...
      <div className='container mx-auto flex gap-8 px-6 py-8'>
          ...
          <nav className='sticky top-24 space-y-6'>
            <div>
              ...
              <ul className='space-y-2'>
                <li>
                  <a href='#introduction' className='block text-sm text-[#454545] hover:text-[#141414] transition-colors'>Introduction</a>
                </li>
                <li>
                  <a href='#capabilities' className='block text-sm text-[#454545] hover:text-[#141414] transition-colors'>
                    Key Capabilities
                  </a>
                </li>
                <li>
                  <a href='#commercial' className='block text-sm text-[#454545] hover:text-[#141414] transition-colors'>Commercial Model</a>
                </li>
              </ul>
            </div>
            <div>
        ...
        <main className='flex-1 max-w-3xl'>
          <article className='prose prose-neutral max-w-none'>
            <h1 id='introduction' className='font-sans text-4xl font-bold text-[#141414] mb-4 scroll-mt-8'>
            ...
            <p className='text-base text-[#454545] leading-relaxed mb-8'>
              ...
              strategies via the X402 protocol. Creators retain full pricing control, with the platform facilitating trustless settlement.
            </p>

            <h2 id='capabilities' className='text-3xl font-bold text-[#141414] mt-16 mb-6 scroll-mt-8'>Key Capabilities</h2>
            <ul className='space-y-4 mb-8'>
              <li className='text-[#454545]'>
                <strong className='text-[#141414]'>Lifecycle Management:</strong>{' '}
                End-to-end strategy creation, validation, semantic versioning, and liveness monitoring.
              </li>
              <li className='text-[#454545]'>
                <strong className='text-[#141414]'>Intelligent Discovery:</strong>{' '}
                Advanced marketplace search with performance-based filtering, risk scoring, and community ratings.
              </li>
              <li className='text-[#454545]'>
                <strong className='text-[#141414]'>Decentralized Settlement:</strong>{' '}
                Native X402 protocol integration for trustless, friction-free payments.
              </li>
              <li className='text-[#454545]'>
                <strong className='text-[#141414]'>Creator Dashboard:</strong>{' '}
                Granular revenue tracking, subscriber analytics, and churn metrics.
              </li>
              <li className='text-[#454545]'>
                <strong className='text-[#141414]'>Composability Engine:</strong>{' '}
                Support for strategy composition (bundling) and forking (remixing), enabling a "GitHub for Alpha" dynamic.
              </li>
              <li className='text-[#454545]'>
                <strong className='text-[#141414]'>Universal Compatibility:</strong> Multi-chain and multi-protocol architecture.
              </li>
            </ul>

            <h2 id='commercial' className='text-3xl font-bold text-[#141414] mt-16 mb-6 scroll-mt-8'>Commercial Model</h2>
            <ul className='space-y-4 mb-8'>
              <li className='text-[#454545]'>
                <strong className='text-[#141414]'>Creator-First Pricing:</strong>{' '}
                Flexible tools for creators to set flat-fee or streaming-based pricing.
              </li>
              <li className='text-[#454545]'>
                <strong className='text-[#141414]'>Transparent Fees:</strong>{' '}
                3% protocol fee on transaction volume; 97% net revenue to the creator.
              </li>
              <li className='text-[#454545]'>
                <strong className='text-[#141414]'>Flexible Access:</strong>{' '}
                Native support for one-time unlocking, recurring subscriptions, and pay-per-call (streaming) models.
              </li>
            </ul>

            <h2 id='realtime' className='text-3xl font-bold text-[#141414] mt-16 mb-6 scroll-mt-8'>Real-Time Infrastructure</h2>
            <ul className='space-y-4 mb-8'>
              <li className='text-[#454545]'>
                <strong className='text-[#141414]'>Low-Latency Streaming:</strong>{' '}
                Built on WebTransport API for high-throughput, bidirectional data streams essential for HFT (High-Frequency Trading)
                contexts.
              </li>
              <li className='text-[#454545]'>
                <strong className='text-[#141414]'>Live Execution:</strong> Instant broadcast of strategy signals and execution updates.
              </li>
              <li className='text-[#454545]'>
                <strong className='text-[#141414]'>Telemetry:</strong> Real-time market data feeds and performance metric streaming.
              </li>
            </ul>
            ...
            <ul className='space-y-4 mb-8'>
              <li className='text-[#454545]'>
                <strong className='text-[#141414]'>Interactive Docs:</strong> Full OpenAPI specifications powered by Scalar.
              </li>
              <li className='text-[#454545]'>
