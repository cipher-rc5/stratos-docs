    ...
    <div className="min-h-screen bg-[#141414] text-[#f2efe9]">
      ...
      <header className="border-b border-[#2a2a2a] bg-[#141414]">
        <div className="container mx-auto flex items-center justify-between px-6 py-4">
          ...
          <nav className="flex items-center gap-6">
            <Link href="/docs" className="text-sm font-medium hover:text-[#dcee24] transition-colors">
              Documentation
            </Link>
            <Link href="/api/reference" className="text-sm font-medium hover:text-[#dcee24] transition-colors">
              API Reference
            </Link>
            <a
      ...
      <main className="container mx-auto px-6 py-20">
        <div className="max-w-4xl">
          <h1 className="font-tektur text-6xl font-bold tracking-tight text-[#f2efe9] mb-6">
            The Decentralized Strategy Layer
          </h1>
          ...
          <p className="text-lg text-[#a1a1a1] mb-12 leading-relaxed">
            ...
            agents discover and consume these strategies via the X402 protocol.
          </p>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-[#a1a1a1]">
                    {" "}
                    Built on WebTransport API for high-throughput, bidirectional data streams essential for HFT
                    contexts.
                  </span>
                </div>
              </li>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              <a
                ...
                className="text-sm text-[#a1a1a1] hover:text-[#dcee24] transition-colors"
              >
                API Endpoint
              </a>
            </div>
